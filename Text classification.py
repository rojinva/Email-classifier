...
__date__ ="$Sep 24, 2013 5:25:18 PM$"
...
if __name__ == '__main__':
    ...
    #texts['fruit'] = 'http://litfuel.net/plush/files/disambiguation/apple-fruit-training.txt'
    texts['company'] = 'http://litfuel.net/plush/files/disambiguation/apple-company.txt'
    #texts['company'] = 'http://litfuel.net/plush/files/disambiguation/apple-company-training.txt'
