...
if __name__ == '__main__':
    ...
    for j in range(sheet.nrows):
      ...
      line = re.sub('[-*>]', '', line)
      line = re.sub('[\n]', '', line)
      line1 = sheet.cell_value(j,2)
      store = [(line, line1)]
      training_set = training_set + store
    ...
    book2 = xlwt.Workbook()
    sh = book2.add_sheet("sheet")

    print "Classification started......."
    for j in range(sheet1.nrows):
      id = sheet1.cell_value(j,0)
      line1 = sheet1.cell_value(j,1)
      line1 = re.sub('[-*>]', '', line1)
      line1 = re.sub('[\n]', '', line1)
      result = classifier.classify(line1)
      sh.write(j, 0, id)
      sh.write(j, 1, result)

    book2.save("C:/Documents and Settings/rojin.varghese/Desktop/LargeTest/classification_with_class.xls")
